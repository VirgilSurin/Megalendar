...
BAC3-Chimie
        ...
        String table = "/html/body/div[3]/div/table/tbody/tr[2]/td/table/tbody/tr[2]/td/div/div[2]/div/div[1]/table[1]/tbody";
        String table2 = "/html/body/div[3]/div[1]/table/tbody/tr[2]/td/table/tbody/tr[2]/td/div/div[2]/div/div[1]/table[1]";
        ...
        for(int i=1; i<2/*optionArray.length*/; i++) {
            ...
            List<WebElement> rows = driver.findElements(By.xpath(table2));
